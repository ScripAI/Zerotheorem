...
const Home = () => {
  return (
    <>
      ...
      <main className="m-auto h-screen flex flex-col">
...
<div className="flex flex-col items-center justify-center">
      <img src={bg.src} className="w-1/2 text-center h-full object-cover" />
      </div>

<div>
        <div className="line w-full  pt-2 bg-cover bg-center bg-no-repeat bg-gradient-to-t from-[hsl(var(--hero-gradient-from))] via-[hsl(var(--hero-gradient-via))] to-[hsl(var(--hero-gradient-to))] text-[hsl(var(--hero-text))] flex flex-col text-center text-base font-extrabold  xs:text-2xl sdm:text-4xl sm:gap-3 md:text-5xl mdx:text-6xl transition-colors duration-200">
