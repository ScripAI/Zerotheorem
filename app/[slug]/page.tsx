...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: seoData.description || `Use our AI-powered ${pageData.name} tool to create amazing content.`,
...
const ToolPage = ({ params }: PageProps) => {
  ...
  const relatedArr = pageObj.filter((obj) => pageData.related?.includes(obj.url)) || [];
