        ...
        <>
          ...
          >
            <Popover.Panel className="absolute left-0 z-10 mt-3 w-screen max-w-full sm:max-w-sm lg:max-w-2xl transform">
              <div className="overflow-hidden  shadow-lg ring-1 ring-base-content ring-opacity-5">
                <div className="relative grid gap-4 bg-base-100 p-4 lg:grid-cols-2">
                  <div className="text-sm flex items-center gap-3 p-2 cursor-pointer hover:bg-base-200  duration-200">
                    <span className="flex items-center justify-center w-12 h-12 shrink-0  bg-orange-500/20">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                  ...
                  <div className="text-sm flex items-center gap-3 p-2 cursor-pointer hover:bg-base-200  duration-200">
                    <span className="flex items-center justify-center w-12 h-12 shrink-0  bg-yellow-500/20">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                  ...
                  <div className="text-sm flex items-center gap-3 p-2 cursor-pointer hover:bg-base-200  duration-200">
                    <span className="flex items-center justify-center w-12 h-12 shrink-0  bg-green-500/20">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
